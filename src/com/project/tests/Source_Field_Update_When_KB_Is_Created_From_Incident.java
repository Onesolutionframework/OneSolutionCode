...
public class Source_Field_Update_When_KB_Is_Created_From_Incident extends PageInitialize {
    ...
    @Test(enabled = true)
    public void Source_Field_Update_When_KB_Is_Created_From_Incident() throws InterruptedException, AWTException {
