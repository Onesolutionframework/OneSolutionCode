...
public class CreateNewKBArticleFromKnowledgeModuleTest extends PageInitialize {
    ...
    @Test(enabled = true)
    public void CreateNewKBArticleFromKnowledgeModuleTest() throws InterruptedException, AWTException {
