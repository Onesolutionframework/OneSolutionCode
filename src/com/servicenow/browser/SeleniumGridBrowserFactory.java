...
public class SeleniumGridBrowserFactory implements BrowserFactory {
    ...
    public com.servicenow.browser.SeleniumGridBrowserFactory withBrowser(String browser) {
    ...
    public com.servicenow.browser.SeleniumGridBrowserFactory withBrowserVersion(String browserVersion) {
    ...
    public com.servicenow.browser.SeleniumGridBrowserFactory withPlatform(Platform platform) {
    ...
    public boolean equals(Object obj) {
        ...
        com.servicenow.browser.SeleniumGridBrowserFactory rhs = (com.servicenow.browser.SeleniumGridBrowserFactory)obj;
    ...
    public com.servicenow.browser.SeleniumGridBrowserFactory withDesiredCapability(String name, String value) {
